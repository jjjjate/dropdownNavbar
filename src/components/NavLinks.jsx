        ...
        <div>
          <div className="px-3 text-left md:cursor-pointer group">
            <h1 className="py-7 flex justify-between items-center md:pr-0 pr-5 group"
              ...
              <span className="text-xl inline md:mt-1 md:ml-2 md:block hidden group-hover:rotate-180 group-hover:-mt-2">
              ...
              link.subLinks.map((slinks) => (
                <div>
                  ...
                  <div className={`${subHeading === slinks.Head ? "md:hidden" : "hidden"}`}>
                    {slinks.mySubLink.map(slink => (
                      <li className="py-3 pl-14">
                        <Link className="hover:text-blue-600" to={slink.link}>
                          {slink.name}
                        </Link>
                      </li>
                    ))}
